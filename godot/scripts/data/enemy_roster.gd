...
static func all() -> Array[EnemyData]:
	return [
		...
		# 小さくて素早い。ほぼ負けない導入。
		_enemy(1, "ENEMY_1_1", 6.0, 0.8, 0.5, 0.97, 1.0, 12.0),
		_enemy(1, "ENEMY_1_2", 6.5, 0.7, 0.55, 0.98, 1.0, 12.5),
		_enemy(1, "ENEMY_1_3", 6.2, 1.0, 0.46, 0.97, 1.0, 11.9),
		_enemy(1, "ENEMY_1_4", 6.8, 0.6, 0.6, 0.98, 1.0, 11.7),
		_enemy(1, "ENEMY_1_5", 6.4, 0.85, 0.52, 0.975, 1.0, 11.0),
		_enemy(2, "ENEMY_2_1", 7.0, 1.2, 0.8, 0.97, 1.0, 15.0),
		_enemy(2, "ENEMY_2_2", 7.5, 1.1, 0.85, 0.98, 1.0, 15.5),
		_enemy(2, "ENEMY_2_3", 7.2, 1.5, 0.74, 0.97, 1.0, 14.5),
		_enemy(2, "ENEMY_2_4", 7.8, 0.95, 0.92, 0.985, 1.0, 14.8),
		_enemy(2, "ENEMY_2_5", 7.4, 1.3, 0.82, 0.98, 1.0, 13.6),
		_enemy(3, "ENEMY_3_1", 8.0, 2.0, 1.2, 0.98, 1.0, 16.5),
		_enemy(3, "ENEMY_3_2", 8.5, 1.8, 1.25, 0.985, 1.0, 17.0),
		_enemy(3, "ENEMY_3_3", 8.2, 2.5, 1.12, 0.98, 1.0, 15.2),
		_enemy(3, "ENEMY_3_4", 8.8, 1.55, 1.32, 0.985, 1.0, 17.6),
		_enemy(3, "ENEMY_3_5", 8.4, 2.1, 1.22, 0.982, 1.0, 15.3),
		_enemy(4, "ENEMY_4_1", 9.0, 3.0, 1.6, 0.98, 1.0, 20.0),
		_enemy(4, "ENEMY_4_2", 9.5, 2.8, 1.7, 0.985, 1.0, 20.5),
		_enemy(4, "ENEMY_4_3", 9.2, 3.6, 1.5, 0.98, 1.0, 19.7),
		_enemy(4, "ENEMY_4_4", 9.8, 2.4, 1.78, 0.985, 1.0, 21.0),
		_enemy(4, "ENEMY_4_5", 9.4, 3.1, 1.62, 0.982, 1.0, 19.6),
		...
		_enemy(5, "ENEMY_5_1", 8.5, 4.5, 2.4, 0.98, 1.0, 26.0),
		_enemy(5, "ENEMY_5_2", 8.5, 5.2, 2.25, 0.98, 1.0, 25.6),
		_enemy(5, "ENEMY_5_3", 8.5, 3.9, 2.55, 0.98, 1.0, 26.6),
		_enemy(5, "ENEMY_5_4", 8.5, 4.6, 2.4, 0.98, 1.0, 25.4),
		_enemy(5, "ENEMY_5_5", 8.5, 4.9, 2.32, 0.98, 1.0, 25.6),
	]
